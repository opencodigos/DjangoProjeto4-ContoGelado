...
- **jQuery:** Biblioteca para manipulação de DOM e eventos.
- **Font Awesome:** Para ícones gráficos.
- **Bootstrap 5:** Framework CSS para estilização e componentes.

### **Arquivos Importantes**

#### **base.html**
- Carrega scripts necessários (`jQuery` e `Font Awesome`).
- Define o esqueleto da página com um container para conteúdo e `navbar.html` inclusos.
...
#### **navbar.html**
- Cria uma barra de navegação (navbar) com links dinâmicos.
- Exibe itens como "Inicio", "Contato", "Cardápio", e, se o usuário estiver autenticado, exibe "Meus Pedidos" e o nome do usuário.
